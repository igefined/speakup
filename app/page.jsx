...
const comments = [
  {
    id: 1,
    text: '"I have been using this platform for a few months now and it has greatly improved my English speaking skills. The gamification features make learning fun and engaging."',
    author: {
      name: 'John Doe',
      position: 'English Teacher, ABC School',
  ...
  {
    id: 2,
    text: '"This platform is amazing! It has helped me gain confidence in speaking English and the AI feature provides valuable feedback."',
    author: {
      name: 'Jane Smith',
...
const SLIDES = [
  ...
  {
    index: 2,
    text: 'Join the English Learning Community2',
    description: 'Connect with others and practice your English skills',
  },
  {
    index: 3,
    text: 'Join the English Learning Community3',
    description: 'Connect with others and practice your English skills',
  }
]
  ...
  return (
      <div>
        ...
        <div className="sm:mb-40 mb-20">
          <div className="-mt-20 sm:mt-0 mx-auto grid max-w-1xl grid-cols-1 items-center gap-x-20 lg:max-w-1xl lg:grid-cols-2">
              ...
              <div
                ...
                <ul className="border-t mb-8 space-y-4 text-gray-400 py-10">
                  ...
                  <li className="flex items-center">
                    ...
                    <span className="group-hover:text-white font-gilroy">10 transactions per month</span>
                  </li>
                  <li className="flex items-center">
                    <svg className="h-6 w-6 text-green-500 mr-2" xmlns="http://www.w3.org/2000/svg"
                         fill="none" viewBox="0 0 24 24" stroke="currentColor">
